    ...
    return (
        <div className="flex flex-col grow shrink h-60 w-[184px]">
            <div className="flex flex-col py-5 pr-5 w-full bg-white rounded-2xl">
                ...
                <div className="gap-1 self-end mt-1 text-xs leading-4 text-right text-stone-500">
                ...
                <div className="flex gap-3 items-start mt-1 w-full text-base font-medium leading-none text-neutral-100">
