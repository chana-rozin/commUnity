...
import { UsersRolesInCommunity } from "@/types/general.type";
...
const communities: Community[] = [{
    ...
    imageUrl: "https://i.pinimg.com/736x/dd/bb/9f/ddbb9f6bde9d9969a314024c728bcb29.jpg",
    members: [{
        _id: "1234",
        first_name: "John",
        last_name: "Doe",
        profile_picture_url: "bhjbv",
        role: UsersRolesInCommunity.Admin
    },
    {
        _id: "1234",
        first_name: "Yael",
        last_name: "Shira",
        profile_picture_url: "bhjbv",
        role: UsersRolesInCommunity.Member
                                ...
                                communities?.map((c: Community) => {
                                    return (
                                        <section onClick={() => handleclick(c)} className="flex flex-wrap gap-8 items-start self-stretch w-full text-sm max-md:max-w-full mt-7 border-b border-solid border-b-slate-200 cursor-pointer p-4 rounded-md">
                                            <img src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjyZ79mCAHGozBeewv6tXKVgt9QFPRrRmv0Q&s"} alt="profile" className="w-10 rounded-full object-cover" />
                                            <h2 className=" inline">
                                                {c.name}
                                            </h2>
                                            <p className="inline">
