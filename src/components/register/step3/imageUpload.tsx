...
export const ImageUpload: React.FC<ImageUploadProps> = ({
    ...
    return (
        ...
        <>
            ...
            {imageUrl && <div className=" min-h-[500px] flex overflow-hidden flex-col flex-1 shrink justify-center p-6 mt-10 w-full bg-white border border-dashed basis-0 border-slate-300 min-w-[240px] rounded-[32px] max-md:px-5 max-md:max-w-full" >
