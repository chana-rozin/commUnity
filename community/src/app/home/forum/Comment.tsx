...
export const CommentComp: React.FC<CommentProps> = ({  creatorId, createdDate, content}) => {
  return (
    <>
      {createdDate && (
      ...
      <div className="flex flex-wrap items-start mt-5 w-full max-md:max-w-full">
        ...
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/68b95c1707a8445652f77e217614fe7ec26ad8b08cd2f80fdc0fcd5190bb58e2?placeholderIfAbsent=true&apiKey=86fe1a7bbf6141b4b43b46544552077e" alt="" className="object-contain shrink-0 aspect-square w-[31px]" />
      </div>
    </>
  );
};